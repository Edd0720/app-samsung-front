...
import com.example.dreamai.data.ExerciseSessionData
import com.example.dreamai.workers.ReadStepWorker
...
class HealthConnectManager(private val context: Context) {
  ...
  suspend fun getGrantedPermissions(permissions: Set<String>): Set<String> {
